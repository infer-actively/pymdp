...
from inferactively.core import utils, softmax, spm_dot, spm_wnorm, spm_cross, run_fpi
...
def update_posterior_states(A, obs, prior, method=FPI, return_numpy=True):
    ...
    @NOTE can we adapt this function to have the prior as optional?
    ...
    **kwargs: List of keyword/parameter arguments corresponding to parameter values for the respective variational inference algorithm
    ...
    if method is FPI:
        qx = run_fpi(A, obs, prior, n_observations, n_states)
    elif method is VMP:
    ...
    if return_numpy:
        ...
        return utils.to_categorical(qx)
