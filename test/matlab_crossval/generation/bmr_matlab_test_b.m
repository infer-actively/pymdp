...
q_dir = rand(8, 1);
p_dir = ones(8, 1);
r_dir = ones(8, 3); % 3 different reduced models

r_dir(5,1) = 2;
r_dir(6,2) = 2;
r_dir(7,3) = 2;

[F, s_dir] = spm_MDP_log_evidence(q_dir,p_dir,r_dir);

save_dir = 'output/bmr_test_b.mat';
save(save_dir, 'q_dir', 'p_dir', 'r_dir', 's_dir', 'F');
