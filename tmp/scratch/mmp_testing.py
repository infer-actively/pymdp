...
print(f"qs1 len {len(qs1)} qs [0] {qs1[0]} qss len {len(qss)} qss [0] {qss[0]} F {F} F_pol {F_pol}")

qs2 = core.algos.run_fpi(
    A, obs_t[0], num_obs, num_states, prior=None, num_iter=10, dF=1.0, dF_tol=0.001
)
