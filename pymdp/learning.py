...
def update_obs_likelihood_dirichlet(pA, A, obs, qs, lr=1.0, modalities="all"):
    ...
    Returns
    -----------
    qA: numpy ndarray of dtype object, optional
...
def update_state_likelihood_dirichlet(
    ...
    qs: numpy 1D array, numpy ndarray of dtype object, optional
        Marginal posterior beliefs over hidden states at current timepoint
    qs_prev: numpy 1D array, numpy ndarray of dtype object, optional
    ...
    Returns
    -----------
    qB: numpy ndarray of dtype object, optional
...
def update_state_prior_dirichlet(
    ...
    Returns
    -----------
    qD: numpy ndarray of dtype object, optional
...
def prune_A(A, obs_levels_to_prune, state_levels_to_prune, dirichlet = False):
    ...
    obs_levels_to_prune: list of int or list of list: 
        ...
        then this will be a list of lists, where each sub-list within `obs_levels_to_prune` will contain the observation levels 
...
def prune_B(B, state_levels_to_prune, action_levels_to_prune, dirichlet = False):
    ...
    state_levels_to_prune: list of int or list of list 
        ...
        then this will be a list of lists, where each sub-list within `state_levels_to_prune` will contain the state levels 
    ...
    action_levels_to_prune: list of int or list of list:
        ...
        then this will be a list of lists, where each sub-list within `action_levels_to_prune` will contain the control state levels 
